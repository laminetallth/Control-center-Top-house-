...
async function exportVendorExcel(){
    ...
    const html = `
        ...
        <body>
            ...
            <div class="header-report">
                <div class="title">TOP HOUSE - Report Venditore</div>
                <div class="subtitle">
                    Venditore: ${venditore.nome} | Zona: ${venditore.zona} | Mensilità: ${meseSelezionato} | Esportato il: ${dataExport}
                </div>
            </div>
    ...
    link.download = `report-venditore-${nomeFile}-${meseFile}.xls`;
